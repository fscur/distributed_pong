...
void
ImGui_ImplGlfwGL3_MouseButtonCallback(struct GLFWwindow* window,
                                      int button,
                                      int action,
                                      int mods) {
...
void
ImGui_ImplGlfwGL3_ScrollCallback(struct GLFWwindow* window,
                                 double xoffset,
                                 double yoffset) {
...
void
ImGui_ImplGlfwGL3_KeyCallback(struct GLFWwindow* window,
                              int key,
                              int scancode,
                              int action,
                              int mods) {
...
ImGui_ImplGlfwGL3_CreateFontsTexture() {
  ...
  ImFontAtlas_GetTexDataAsRGBA32(
      io->Fonts, &pixels, &width, &height, &bytesPerPixel);
